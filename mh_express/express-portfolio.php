<?php
/*
  Template Name: MH Express Portfolio Page Template
 */
?>
<!DOCTYPE html>
...
<div class="wrapper">
  <div class="header-wrapper">     <?php include get_template_directory() . "/common/header-1.php"; ?>
...
<?php wp_footer();?>
<?php include get_template_directory() . "/common/modal.php"; ?>
</body>
</html>